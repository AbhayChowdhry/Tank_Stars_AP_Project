...
//        Terrain
        ...
        //Player 1 Snout
        play.getPlayer1().getTank().getSnout().setPosition((float)(tank_1_position+play.getPlayer1().getTank().getSnout_x()/1.5f), (float)(height[tank_1_position]+play.getPlayer1().getTank().getSnout_y()/1.5f));
